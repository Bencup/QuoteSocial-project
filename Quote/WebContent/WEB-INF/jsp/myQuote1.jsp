							...
							<div class="panel panel-default" id="forFade">
 							<div class="panel-heading bPanelColor" >
 								<div class="row">  	
        							...
        							<%-- <a href="${pageContext.request.contextPath}/afterMy.html?id=${board.id}" data-id="${board.id}" class="board-id-for-canvas" data-toggle="tooltip" data-placement="left"  title="Share" > 
